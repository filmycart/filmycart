...
class Interceptor extends \Sm\BasicProducts\Block\BasicProducts implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function _prepareLayout()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_prepareLayout', func_get_args(), $pluginInfo) : parent::_prepareLayout();
    }
    ...
    public function _helper()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_helper', func_get_args(), $pluginInfo) : parent::_helper();
    }
    ...
    public function _getCfg($attr = null, $data = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_getCfg', func_get_args(), $pluginInfo) : parent::_getCfg($attr, $data);
    }
    ...
    public function _getConfig($name = null, $value_def = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_getConfig', func_get_args(), $pluginInfo) : parent::_getConfig($name, $value_def);
    }
    ...
    public function _setConfig($name, $value = null)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('_setConfig', func_get_args(), $pluginInfo) : parent::_setConfig($name, $value);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getSelectSource');
        return $pluginInfo ? $this->___callPlugins('_getSelectSource', func_get_args(), $pluginInfo) : parent::_getSelectSource();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getProductMedia');
        return $pluginInfo ? $this->___callPlugins('_getProductMedia', func_get_args(), $pluginInfo) : parent::_getProductMedia();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getProductCatalog');
        return $pluginInfo ? $this->___callPlugins('_getProductCatalog', func_get_args(), $pluginInfo) : parent::_getProductCatalog();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getProductsBasic');
        return $pluginInfo ? $this->___callPlugins('_getProductsBasic', func_get_args(), $pluginInfo) : parent::_getProductsBasic($catids, $countProduct);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getProductsIDs');
        return $pluginInfo ? $this->___callPlugins('_getProductsIDs', func_get_args(), $pluginInfo) : parent::_getProductsIDs();
    }
