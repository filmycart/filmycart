...
class Interceptor extends \Sm\ImageSlider\Block\ImageSlider implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_getProducts');
        return $pluginInfo ? $this->___callPlugins('_getProducts', func_get_args(), $pluginInfo) : parent::_getProducts();
    }
